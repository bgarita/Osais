...
-- Cambios en base de datos osais
-- Aplicar en todas las base de datos de Osais como: 
-- 		laflor, ana, model, contadm, contaxyz, contabosco
...
BEGIN
	...
	Importante: 
		1. Cuando se abre un periodo que está n periodos antes del actual, todos los n periodos quedarán automáticamente abiertos.
		2. Es responsabilidad del contador utilizar este proceso ya que se modificarán datos de informes ya emitidos.
		3. Todos los asientos de cierre del periodo recién reabierto serán eliminados (el usuario deberá generarlos de nuevo).
	*/
	...
	if vError = 0 then
		...
		*/
		...
		-- Eliminar todos los datos de los registros trasladados y también los que corresponden a cierre anual (si existen).
		-- Primero de la tabla de detalle.
