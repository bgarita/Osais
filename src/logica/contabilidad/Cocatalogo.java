...
public class Cocatalogo extends Cuenta implements IEstructuraBD {
    ...
    /**
     * Anque el método existe no se recomienda usarlo ya que la fecha
     * de creación debe ser automática. Ver método insert()
     * @param fecha_c 
     */
    ...
    /**
     * Formatea una cuenta tipo título. Normalmente se utiliza para las
     * cuentas que llevan el nombre de una persona.
     ...
     * @return Cocatalogo[] arreglo de objetos que representa todo el catálogo contable.
     */
    ...
    /**
     * Este método devuelve true cuando ocurre un error ya sea en la clase
     * padre o en ella misma.
    ...
    /**
     * Este método devuelve el mensaje de error ya sea que haya ocurrido
     * en la clase padre o en ella misma.
    ...
    /**
     * Este método consulta la base de datos para ver si la cuenta
     * existe o no.
     ...
     * se guardarán.
     * Nota 1: No controla transacciones ni verifica si el registro existe.  Esto
     * es una labor que debe hacer antes el programa que lo invoque.
     * Nota 2: Los campos de montos no se actualizan desde esta clase.
     ...
     * se eliminará.
     * Nota: La única verificación que se hace es que el saldo esté en cero.  
     * Cualquier otra lo deberá hacer hacer el programa que lo invoque y el 
