...
public final class Config extends javax.swing.JFrame implements IMantenimiento {
    ...
    private void initComponents() {
        ...
        txtFacimpu = new javax.swing.JFormattedTextField();
        ...
        jLabel3.setText("Impuesto al valor agregado");

        txtFacimpu.setColumns(6);
        txtFacimpu.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        txtFacimpu.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtFacimpu.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtFacimpu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtFacimpuActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(53, 53, 53)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtFacimpu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtFacimpuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtFacimpuActionPerformed
        txtFacimpu.transferFocus();
    }//GEN-LAST:event_txtFacimpuActionPerformed
    ...
    private javax.swing.JComboBox cboDiaOferta;
    private javax.swing.JComboBox cboImpresion;
    private javax.swing.JComboBox cboMascaratel;
    private javax.swing.JComboBox cboMoneda;
    private javax.swing.JComboBox cboMovtidoE;
    private javax.swing.JComboBox cboMovtidoS;
    private javax.swing.JComboBox cboVariarPrecios;
    private javax.swing.JComboBox cbocodigoDolar;
    private javax.swing.JComboBox cboformatoCant;
    private javax.swing.JComboBox cboformatoPrecio;
    ...
    private javax.swing.JFormattedTextField txtFacimpu;
    ...
    public void guardarRegistro() {
        ...
        try {
            facimpu = Float.parseFloat(
                    Ut.quitarFormato(txtFacimpu.getText().trim()));
        } catch (Exception ex) {
            Logger.getLogger(Config.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null,
                    ex.getMessage(),
        ...
        if (!primeraVez) {
            ...
            sqlUpdate
                    ...
                    "clicode        = ?," + // 36
                    "DistPago       = ?," + // 37
                    "formatoCant    = ?," + // 38  Bosco agregado 24/12/2013
                    "formatoPrecio  = ?," + // 39  Bosco agregado 24/12/2013
                    "imprimirFactura= ?," + // 40  Bosco agregado 26/12/2013
                    "asignarprovaut = ?," + // 41  Bosco agregado 30/12/2013
                    "precioOferta   = ?," + // 42  Bosco agregado 01/03/2014
                    "diaOferta      = ?," + // 43  Bosco agregado 01/03/2014
                    "movtidoE       = ?," + // 44  Bosco agregado 08/02/2015
                    "movtidoS       = ?," + // 45  Bosco agregado 08/02/2015
                    "genmovcaja     = ?," + // 46  Bosco agregado 08/07/2015
                    "enviarFacturaE = ?," + // 47  Bosco agregado 17/07/2019
                    "sincronizarTablas = ?"; // 48  Bosco agregado 16/08/2016
        ...
        try {
            ...
            ps.setFloat(3, facimpu);
            ps.setShort(4, notifComInt);
            ps.setString(5, wallPaper);
            ps.setString(6, codigoTC);
            ps.setString(7, codigoDolar);
            ps.setShort(48, sincronizar);

            // Cejilla Inventarios
            ps.setShort(8, precioAut);
            ps.setShort(9, redondear);
            ps.setShort(10, multiBodega);
            ps.setShort(11, bloquearConsDi);
            ps.setString(12, bodega);
            ps.setShort(44, movtidoE);
            ps.setShort(45, movtidoS);

            // Cejilla Facturación
            ps.setFloat(13, descAutomatico);
            ps.setShort(14, bloqDias);
            ps.setShort(15, exist0);
            ps.setShort(16, precio0);
            ps.setShort(17, redond5);
            ps.setShort(18, bloquearConsF);
            ps.setShort(19, bloquearFechaF);
            ps.setShort(20, bloquearNpag);
            ps.setShort(21, bloquearCatP);
            ps.setShort(22, usarIvi);
            ps.setShort(23, diasFactTemp);
            ps.setShort(24, variarprecios);
            ps.setString(25, timbre);
            ps.setShort(26, genasienfac);
            ps.setShort(46, genmovcaja);
            ps.setShort(47, enviarFacturaE);

            // Cejilla Cuentas por cobrar
            ps.setShort(27, diasDevol);
            ps.setFloat(28, mora);
            ps.setShort(29, intervalo);
            ps.setFloat(30, incrementoM);
            ps.setShort(31, diasG);
            ps.setShort(32, creditoaf);
            ps.setShort(33, aplicarNotaC);
            ps.setShort(34, bloquearConR);
            ps.setShort(35, factcomoPOS);
            ps.setInt(36, clicode);
            ps.setShort(37, distPago);
            ps.setString(38, formatoCant);      // Bosco agregado 24/12/2013
            ps.setString(39, formatoPrecio);    // Bosco agregado 24/12/2013
            ps.setBoolean(40, imprimirFactura); // Bosco agregado 26/12/2013
            ps.setBoolean(41, asignarprovaut);  // Bosco agregado 30/12/2013
            ps.setShort(42, precioOferta);      // Bosco agregado 01/03/2014
            ps.setShort(43, diaOferta);         // Bosco agregado 01/03/2014
