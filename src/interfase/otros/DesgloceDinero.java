 ...
 * @author bosco
 */
public class DesgloceDinero extends javax.swing.JFrame {
     ...
     * @param cj
     */
    public DesgloceDinero(CierreCaja cj) {
        initComponents();
        this.cj = cj;
    }

    // Desplegar el monto anterior (el que viene por parámetro)
    public void setMontoAnterior(javax.swing.JFormattedTextField campo){
        this.total = campo;
        try {
            this.montoAnterior =
                    Double.parseDouble(Ut.quitarFormato(campo.getText().trim()));
        } catch (Exception ex) {
    ...
    public void loadRecord(){
        String sqlSent = "Select * from cadesglocem Where dFecha1 = ? and dFecha2 = ?";
        PreparedStatement ps;
        ResultSet rs;
        try {
            ps = cj.conn.prepareStatement(sqlSent, 
    ...
    private void btnListoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListoActionPerformed
        ...
        sqlDelete = "Delete from cadesglocem Where dFecha1 = ? and dFecha2 = ?";
        
        sqlSent = "SET FOREIGN_KEY_CHECKS=0";
        
        sqlInsert = 
                "INSERT INTO cadesglocem " +
                    "(dFecha1," + //  1
                    "dFecha2, " + //  2
                    "b50000,  " + //  3
                    "b20000,  " + //  4
        ...
        this.total.setText(this.txtTotal.getText());
        try {
            ...
            ps = cj.conn.prepareStatement(sqlDelete);
            ps.setDate(1, dFecha1);
            ps.setDate(2, dFecha2);
            CMD.update(ps);
            ps.close();
            
            ps = cj.conn.prepareStatement(sqlInsert);
            ps.setDate(1, dFecha1);
            ps.setDate(2, dFecha2);
            ps.setInt(3, b50000);
            ps.setInt(4, b20000);
        ...
        cj.setNsaldoFis(this.txtTotal.getText());
        cj.calcularDiferencia();
