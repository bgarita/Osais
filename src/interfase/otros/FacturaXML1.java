 ...
 * @author bgari
 */
public class FacturaXML1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FacturaXML1
     * @param conn
     */
    public FacturaXML1(Connection conn) {
        initComponents();
        this.conn = conn;
    }
    ...
    private void btnSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirActionPerformed
        try {
            ...
            Logger.getLogger(FacturaXML1.class.getName()).log(Level.SEVERE, null, ex);
...
//            java.util.logging.Logger.getLogger(FacturaXML1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new FacturaXML1().setVisible(true);
//            }
//        });
//    }
