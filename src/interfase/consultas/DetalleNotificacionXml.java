...
public class DetalleNotificacionXml extends javax.swing.JDialog {
    ...
    private String getCommand() {
        ...
        try {
            ...
            String cmd
                    ...
                    + ParametrosXML.todoAction // A este punto la acción es "1"
    ...
    private void actualizarEstado() {
        ...
        // JOptionPane.showMessageDialog(null, "Se seleccionaron " + rows.length + " reegistros.");
        int count = 0;
        int row;
        ...
        for (int index = 0; index < rows.length; index++) {
            ...
            // El valor predeterminado es "1" que es Enviar factura
            // La factura se puede enviar todas las veces que sea necesario.
            // El API FE2.exe se encarga de realizar envío o consulta según
            // Corresponda.
            ...
            try {
                ...
                if (os.contains("win") && Menu.enviarDocumentosElectronicos) {
                    ...
                    /**
                     * Este proceso corre bien pero por alguna razón no está
                     * mostrando los joptionpane
                     * Hay que hacer más pruebas. Podría crear un proceso de 
                     * consulta únicamente donde se pida el número de factura
                     * y correr esto mismo para ver qué está pasando. 16/04/2023
                     */
                    ...
                    //JOptionPane.showMessageDialog(null, "Código de finalización: " + endingCode);
                    //JOptionPane.showMessageDialog(null, text);

                    // Estraer el estado
                    int inicial = text.indexOf("@Estado movimiento: ");
                    int fin = text.indexOf("@", inicial + 1);
                    String estado = text.substring(inicial, fin).replace("@Estado movimiento: ", "");

                    inicial = text.indexOf("@Codigo de respuesta ");
                    fin = text.indexOf("@", inicial + 1);
                    String codigoRespuesta = text.substring(inicial, fin).replace("@Codigo de respuesta ", "");

                    inicial = text.indexOf("@Mensaje respuesta de Hacienda: ");
                    fin = text.indexOf("@", inicial + 1);
                    String mensajeHacienda = text.substring(inicial, fin).replace("@Mensaje respuesta de Hacienda: ", "");

//                    String msg
//                            = "Código de respuesta: " + codigoRespuesta + "\n"
//                            + "Estado             : " + estado + "\n"
//                            + "Mensaje Hacienda   : " + mensajeHacienda;
//                    JOptionPane.showMessageDialog(null, msg);
    ...
    // Este método hace uso de la clase FacturaXML.java a través de la clase EnvioFacturaElectronica.java
    // y ésta a su vez de utilizar la clase DocumentoElectronico.java que es la 
    // que se encargar de poner los valores en la clase ParametrosXML.java
    // Cuando se crea la instancia, el constructor recibe la acción en "1" que es enviar factura.
