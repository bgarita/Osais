 ...
 * RepComprasD151.java
 *
 * Created on 23/10/2013, 05:03:00 PM
 */
...
public class RepComprasD151 extends JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(DatFacfech1, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)
        ...
        setSize(new java.awt.Dimension(282, 257));
    ...
    private void cmdImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdImprimirActionPerformed
        ...
        formJasper = "RepComprasD151.jasper";
        ...
        query = "Call Rep_ComprasD151(" + facfech1 + "," + facfech2 + ")";
    ...
    public static void main(Connection c) {
        try {
            if (!UtilBD.tienePermiso(c,"RepComprasD151")){
                JOptionPane.showMessageDialog(null,
            ...
            Logger.getLogger(RepComprasD151.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, 
                    ex.getMessage(),
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
        ...
        try {
            RepComprasD151 run = new RepComprasD151(c);
            run.setVisible(true);
