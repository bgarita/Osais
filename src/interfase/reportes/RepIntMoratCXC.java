 ...
 * RepIntMoratCXC.java
 *
 * Created on 04/11/2010, 08:53:00 PM
 */
...
public class RepIntMoratCXC extends JFrame {
    ...
    /** Creates new form
     * @param c */
    public RepIntMoratCXC(Connection c) {
        inicio = true;
        fin = false;
    ...
    private void initComponents() {
        ...
        setTitle("Intereses moratorios (CXC)");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(DatFacfech2, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
        ...
        cboOrden.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cliente", "Número ND", "Fecha" }));
    ...
    private void cmdImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdImprimirActionPerformed
        ...
        formJasper = "RepIntMoratCXC.jasper";
        ...
        new Reportes(conn).generico(
                ...
                filtro,
                formJasper,
                "Listado de intereses moratorios");
    ...
    */
    public static void main(Connection c) {
        try {
            ...
            if (!UtilBD.tienePermiso(c,"RepIntMoratCXC")){
                JOptionPane.showMessageDialog(null,
            ...
            Logger.getLogger(RepIntMoratCXC.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, 
                    ex.getMessage(),
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
        ...
        RepIntMoratCXC run = new RepIntMoratCXC(c);
        run.setVisible(true);
    } // end main
