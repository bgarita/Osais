...
public class RepAntigSaldosCXC extends JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(437, 395));
    ...
    private void cmdImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdImprimirActionPerformed
        ...
        // Blanco es igual a cero
        clicode1 = clicode1.isEmpty() ? "0" : clicode1;
        clicode2 = clicode2.isEmpty() ? "0" : clicode2;
        clasif1 = clasif1.isEmpty() ? "0" : clasif1;
        clasif2 = clasif2.isEmpty() ? "0" : clasif2;
        clasif3 = clasif3.isEmpty() ? "0" : clasif3;

        // Elimino la coma si existe
        clicode1 = clicode1.replaceAll(",", "");
        clicode2 = clicode2.replaceAll(",", "");
        ...
        query = "Call Rep_AntigSaldCXC(" 
                + clicode1 + "," + clicode2 + "," + soloVenc + "," 
                + saldoMay + "," + clasif1  + "," + clasif2 + "," 
                + clasif3  + "," + fechaDoc + "," + orden + ")";
        query = Ut.sqlFormat(query);
