/*
 * RepVentasxfamilia.java
 *
 * Created on 25/12/2010, 08:24:00 PM
 */
...
public class RepVentasxfamilia extends JFrame {

    private Connection conn = null;
    
    /** Creates new form */
    public RepVentasxfamilia(Connection c) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        cboOrden.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Descripción familia", "Código familia" }));
        ...
        setSize(new java.awt.Dimension(390, 253));
    ...
    private void cmdImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdImprimirActionPerformed
        ...
        formJasper = "RepVentasxfamilia.jasper";
    ...
    */
    public static void main(Connection c) {
        try {
            ...
            if (!UtilBD.tienePermiso(c,"RepVentasxfamilia")){
                JOptionPane.showMessageDialog(null,
            ...
            Logger.getLogger(RepVentasxfamilia.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, 
                    ex.getMessage(),
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
        ...
        try {
            RepVentasxfamilia run = new RepVentasxfamilia(c);
            run.setVisible(true);
