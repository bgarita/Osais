 ...
 * RepDetalleCXC.java
 *
 * Created on 20/11/2010, 11:24:00 AM
 */
...
public class RepDetalleCXC extends JFrame {

    private Connection conn;
    
    /** Creates new form
     * @param c */
    public RepDetalleCXC(Connection c) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Detalle de cuentas por cobrar");
        ...
        cboOrden.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Factura", "Nota de débito", "Nota de crédito", "Recibo" }));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cmdImprimir, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmdImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdImprimirActionPerformed
        ...
        formJasper = "RepDetalleCXC.jasper";
    ...
    */
    public static void main(Connection c) {
        try {
            ...
            if (!UtilBD.tienePermiso(c,"RepDetalleCXC")){
                JOptionPane.showMessageDialog(null,
            ...
            Logger.getLogger(RepDetalleCXC.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, 
                    ex.getMessage(),
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
        ...
        RepDetalleCXC run = new RepDetalleCXC(c);
        run.setVisible(true);
    } // end main
