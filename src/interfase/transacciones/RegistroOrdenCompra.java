...
public class RegistroOrdenCompra extends javax.swing.JFrame {
    ...
    /**
     * Borrar una orden de compra de la base de datos. Este método asume que la
     * base de datos tiene borrado en cascada para que se elimine el detalle de
     * la orden. Si la orden fue cargada de la tabla de órdenes eliminadas, se
     * eliminará de esa misma tabla.
     *
     ...
     * @param calcularMontoDescuento boolean indica si se debe o no calcular el
     * monto del descuento.
     */
