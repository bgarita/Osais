...
public class RegistroAsientos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // Esta lista solo tendrá datos cuando se modifica un asiento existente
        // y el usuario borra una línea de la tabla.
        this.deleteList.forEach((linea) -> {
            linea.delete();
        });
        ...
        old_tipo = 0;
        old_comprob = "";
        this.deleteList = new ArrayList<>(); // Limpiar lista
        JOptionPane.showMessageDialog(null,
    ...
    /**
     * Este método pone en blanco todos los controles para que el usuario pueda ingresar
     * nuevos datos.
     *
...
//        eliminarRegistro(cuenta);
    ...
    private void btnBorrarCuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarCuActionPerformed
        ...
        // Agregar la línea que será borrada al guardar el asiento.  
        // Solo aplica para asientos modificados, pero si el id es negativo no se 
        // incluirá ya que se trata de una línea nueva.
        int idReg = Integer.parseInt(this.tblDetalle.getValueAt(row, 5).toString());
        if (!this.old_comprob.isEmpty() && idReg > 0) {
            CoasientoD linea = new CoasientoD(conn);
            linea.setIdReg(idReg);
            linea.setDb_cr((byte) 0);
            linea.setMonto(0);
            this.deleteList.add(linea);
        }
