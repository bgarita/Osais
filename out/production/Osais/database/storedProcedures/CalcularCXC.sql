...
BEGIN
	...
	-- Debido a que esta tabla es usada por el SP RecalcularSaldoClientes_Cierre
	-- creo un índice para mejorar la velocidad de acceso a los datos.
	CREATE INDEX idx_clicode_tmp ON tmp_faencabe(clicode);
